...
export const SupplierPageHeader = ({ certificationButtonCallback, isSubmitting = false }) => (
  <div tw="flex items-center justify-end">
    <div tw="mt-5 flex space-x-4 mr-4">
      ...
      <button
        ...
        type="submit"
        tw="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
      >
        {!isSubmitting ? (
          <>
...
export const CustomerViewPageHeader = ({ isSubmitting = false }) => (
  <div tw="flex items-center justify-end">
    <div tw="mt-5 flex space-x-4 mr-4">
      <button
        disabled={isSubmitting}
